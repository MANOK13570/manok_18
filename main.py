...
from ian_cpm_garage import CarParkTool

__CHANNEL_USERNAME__ = "Boss_Ian_Cpm_Garage"
__GROUP_USERNAME__   = "Boss_Ian_Cpm_Garage"
...
def banner(console):
    ...
    brand_name = figlet_format('Boss_Ian_Cpm_Garage', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐅𝐁 @ 𝐁𝐎𝐒𝐒 𝐈𝐀𝐍 𝐂𝐏𝐌 𝐆𝐀𝐑𝐀𝐆𝐄')) 
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, '=============[ 𝙰𝙳𝚁𝙴𝚂𝚂 ]============='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝙸𝙰𝙽 𝚃𝙾𝙾𝙻 ]==============='))
